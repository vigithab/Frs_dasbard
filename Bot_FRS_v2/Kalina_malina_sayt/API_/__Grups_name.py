...
url_categories = "https://admin.kalina-malina.ru/api/v1/categories"
groups = get_data_and_print_table(url_categories)
# Преобразуем данные в DataFrame
if groups:
    df = pd.DataFrame(groups)
    # Сохраняем DataFrame в файл Excel с заголовками
    df.to_excel(r"C:\Users\lebedevvv\Desktop\FRS\PYTHON\Bot_FRS_v2\Kalina_malina_sayt\Файлы\Полный список групп.xlsx", index=False)