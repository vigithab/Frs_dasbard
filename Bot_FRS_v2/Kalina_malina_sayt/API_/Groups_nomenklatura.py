import pandas as pd
import requests
import Bot_FRS_v2.Kalina_malina_sayt.API_.__Grups_name as groop
...
def zapros(x):
    ...
    url_categories = f"https://admin.kalina-malina.ru/api/v1/products/?category_id={x}&limit=500&stores=0"
    ...
    x.to_excel(r"C:\Users\lebedevvv\Desktop\FRS\PYTHON\Bot_FRS_v2\Kalina_malina_sayt\Файлы\1.xlsx", index=False)
print("\n")
